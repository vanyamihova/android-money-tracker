...
public class FragmentNavigation extends FragmentBase {
    ...
    public void createAddButton() {
        ...
        addCarCost.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mOnAddButtonListener.onClickAddButton();
...
//                });
    ...
    public OnAddButtonListener mOnAddButtonListener;
    public void setOnAddButtonListener(OnAddButtonListener listener) {
        this.mOnAddButtonListener = listener;
    }
